...
public class DbKindHatUntersuchungAccessHelper extends SQLiteOpenHelper {

    public static final String LOG_TAG = DbKindHatUntersuchungAccessHelper.class.getSimpleName();
    ...
    public DbKindHatUntersuchungAccessHelper(Context context) {
